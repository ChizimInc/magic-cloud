...
from cloud.views import CreateUserMainDirectory, CreateFolder, GetFolder, RenameFile, DeleteFile, FileUploadView, FileDownload
...
urlpatterns = [
    ...
    path('file/download/<int:file_id>', FileDownload.as_view())
]